 ...
 *
 * Ported as-is from menosan-api `app.menosan.analytics` (only the package differs) for offline reports (plan §5.7).
 * Keep it identical to the backend: only the Kotlin stdlib and kotlinx.serialization, no Android APIs.
