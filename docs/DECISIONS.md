...
| 2026-09-24 | AN-0 | Extra preferences (notifications, units, language) and the choice between the type-DELETE and simple delete dialogs are low priority (team). Build the plan's type-DELETE dialog first. | Team decision. |
